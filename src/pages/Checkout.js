...
function Checkout() {
  ...
  const handleRemove = (e, itemId) => {
    dispatch(deleteItemFromCartAsync(itemId), [dispatch]);
  };
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-14 bg-white max-w-7xl px-3 sm:px-2 lg:px-3">
              <div className="border-t border-gray-200 px-0 py-5 sm:px-0">
                <h1 className="text-4xl my-5 mt-3 font-bold tracking-tight text-gray-900">
                  Cart
                </h1>
              ...
              <div className="border-t border-gray-200 px-3 py-6 sm:px-3">
